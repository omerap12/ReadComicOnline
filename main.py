...
global isURL
isURL = False
PREFIX = "https://readcomicsonline.ru/"
...
def initMultipleIssuesDownload():
	...
	url = e.get()
	if not check_for_url_domain(url):
		popUp("Error", "Please enter a valid url.")
		return
...
def check_for_url_domain(url: str) -> bool:
	return True if url.startswith(PREFIX) else False
